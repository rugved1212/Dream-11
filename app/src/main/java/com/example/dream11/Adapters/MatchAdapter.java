...
public class MatchAdapter extends RecyclerView.Adapter<MatchAdapter.ViewHolder> {
    ...
    public MatchAdapter(ArrayList<Match> matches, OnItemClickListener onItemClickListener) {
    ...
    public MatchAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.matches_recyclerview, parent, false);
    ...
    public void onBindViewHolder(@NonNull MatchAdapter.ViewHolder holder, int position) {
        ...
        String team1name = teamName(match.team1);
        String team2name = teamName(match.team2);
        holder.team1.setText(team1name);
        holder.team2.setText(team2name);

        holder.bind(match);

        SimpleDateFormat inputFormat = new SimpleDateFormat("yy-MM-dd HH:mm", Locale.getDefault());
        SimpleDateFormat outputFormat = new SimpleDateFormat("dd MMM yyyy", Locale.getDefault());
        try {
            Date date = inputFormat.parse(match.date);
        ...
        flag1 = flags(match.team1);
        flag2 = flags(match.team2);
    ...
    private void date_of_match(String matchDate) {
        SimpleDateFormat inputFormat = new SimpleDateFormat("yy-MM-dd HH:mm", Locale.getDefault());
        SimpleDateFormat outputFormat = new SimpleDateFormat("dd MMM yyyy", Locale.getDefault());
        try {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            team1IMG = itemView.findViewById(R.id.team1);
            team2IMG = itemView.findViewById(R.id.team2);
            date = itemView.findViewById(R.id.date);
            time_rem = itemView.findViewById(R.id.counterTime);
            handler = new Handler();
        }
        ...
        private void updateCountdown(Match match) {
            ...
            long matchTimeMillis = getTimeInMillis(match.getDate());
            long timeDifferenceMillis = matchTimeMillis - currentTimeMillis;
            ...
            if (days > 0) {
                ...
                if (hours >= 0 && minutes >= 0 && seconds >= 0) {
                    countdownText = String.format(Locale.getDefault(), "%02d:%02d:%02d", hours, minutes, seconds);
                } else {
                    countdownText = "00:00:00";
                }            }
            time_rem.setText(countdownText);
        }
