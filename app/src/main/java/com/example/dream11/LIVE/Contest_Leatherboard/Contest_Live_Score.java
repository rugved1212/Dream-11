package com.example.dream11.LIVE.Contest_Leatherboard;
...
import com.example.dream11.LIVE.Contest_Leatherboard.Fragment.LeaderBoard;
import com.example.dream11.LIVE.Contest_Leatherboard.Fragment.Winnings;
import com.example.dream11.LIVE.Match_Live_Score;
import com.example.dream11.LIVE.Stats;
import com.example.dream11.R;
import com.example.dream11.TeamsAndContest.MyContest;
import com.example.dream11.TeamsAndContest.MyTeams;
...
public class Contest_Live_Score extends AppCompatActivity {

    private ViewPager2 viewPager2;
    private TabLayout tabLayout;
    private Toolbar toolbar;
    String team1, team2, date, status, series, game, contest_key;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_contest_live_score);
        ...
        contest_key = getIntent().getStringExtra("contest_key");
        ...
        ImageView team1img = findViewById(R.id.team1img);
        TextView team2tv = findViewById(R.id.team2);
        ImageView team2img = findViewById(R.id.team2img);
        ...
        TextView team1overs = findViewById(R.id.team1overs);
        TextView team2score = findViewById(R.id.team2score);
        TextView team2overs = findViewById(R.id.team2overs);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    if (game.equals("cricket")) {
                        String score1 = snapshot.child(team1+"_score").getValue(String.class);
                        String overs1 = snapshot.child(team1+"_overs").getValue(String.class);
                        String score2 = snapshot.child(team2+"_score").getValue(String.class);
                        String overs2 = snapshot.child(team2+"_overs").getValue(String.class);

                        team1score.setText(score1);
                        team1overs.setText(overs1);
                        team2score.setText(score2);
                        team2overs.setText(overs2);
                    } else if (game.equals("football")) {
                        Integer score1 = snapshot.child(team1+"_score").getValue(Integer.class);
                        Integer score2 = snapshot.child(team2+"_score").getValue(Integer.class);

                        team1score.setText(String.valueOf(score1));
                        team2score.setText(String.valueOf(score2));
                    } else if (game.equals("kabaddi")) {
                        Integer score1 = snapshot.child(team1+"_points").getValue(Integer.class);
                        Integer score2 = snapshot.child(team2+"_points").getValue(Integer.class);
