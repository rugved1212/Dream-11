...
public class CreateFootballTeam extends AppCompatActivity implements GK.OnSelectedPlayerListener, DEF.OnSelectedPlayerListener, MID.OnSelectedPlayerListener, FOR.OnSelectedPlayerListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_football_team);
        ...
        preview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FootballBottomSheet footballBottomSheet = new FootballBottomSheet(gk, def, mid, forw, "", "", player_selected.getText().toString(), teamName(team1), teamName(team2));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedPlayers.size() >= 11) {
                    Intent intent = new Intent(CreateFootballTeam.this, Select_C_VC.class);
                    intent.putExtra("team1", team1);
                    intent.putExtra("team2", team2);
                    intent.putExtra("date", date);
                    intent.putExtra("status", status);
                    intent.putExtra("series", series);
                    intent.putExtra("game", "football");
    ...
    public void onPlayersSelected(List<Player> selected) {
            ...
            if (currentFragment != null) {
                ...
                while (iterator.hasNext()) {
                    ...
                    switch (currentFragmentTag) {
                        case "f0":
                            if (currentPlayer.getPlayer_position().equals("GOAL-KEEPER")) {
                                iterator.remove();
                                System.out.println("deleted" + currentPlayer);
                            }
                            System.out.println("GK" + currentPlayer.getPlayer_name());
                            break;
                        case "f1":
                            if (currentPlayer.getPlayer_position().equals("DEFENDER")) {
                                iterator.remove();
                                System.out.println("deleted" + currentPlayer);
                            }
                            System.out.println("DEF" + currentPlayer.getPlayer_name());
                            break;
                        case "f2":
                            if (currentPlayer.getPlayer_position().equals("MIDFIELDER")) {
                                iterator.remove();
                                System.out.println("deleted" + currentPlayer);
                            }
                            System.out.println("MID" + currentPlayer.getPlayer_name());
                            break;
                        case "f3":
                            if (currentPlayer.getPlayer_position().equals("FORWARD")) {
                                iterator.remove();
                                System.out.println("deleted" + currentPlayer);
                            }
                            System.out.println("FOR" + currentPlayer.getPlayer_name());
                            break;
                    }
                }
        ...
        Log.w("countWK", " "+countGK);
        Log.w("countBAT", " "+countDEF);
        Log.w("countAR", " "+countMID);
        Log.w("countBOWL", " "+countFOR);
        GK gkfragment = (GK) getSupportFragmentManager().findFragmentByTag("f0");
        DEF deffragment = (DEF) getSupportFragmentManager().findFragmentByTag("f1");
        MID midfragment = (MID) getSupportFragmentManager().findFragmentByTag("f2");
        FOR forfragment = (FOR) getSupportFragmentManager().findFragmentByTag("f3");

        if (gkfragment!=null) {
            System.out.println("gkfound");
        }if (deffragment!=null) {
            System.out.println("deffound");
        }if (midfragment!=null) {
            System.out.println("midfound");
        }if (forfragment!=null) {
            System.out.println("forfound");
        }
        ...
        if (selectedPlayers.size() == 11) {
            ...
            if (gkfragment!=null) {
                System.out.println("gkfound");
                gkfragment.maxSelectionMethod(true);
            }
            if (deffragment!=null) {
                System.out.println("deffound");
                deffragment.maxSelectionMethod(true);
            }
            if (midfragment!=null) {
                System.out.println("midfound");
                midfragment.maxSelectionMethod(true);
            }
            if (forfragment!=null) {
                System.out.println("forfound");
                forfragment.maxSelectionMethod(true);
            }
            ...
            if (countGK == 1) {
                ...
                if (gkfragment!=null)
                    gkfragment.maxSelectionMethod(false);
            }
            if (countDEF == 5) {
                if (deffragment!=null)
                    deffragment.maxSelectionMethod(true);
                ...
                if (deffragment!=null)
                    deffragment.maxSelectionMethod(false);
            }
            if (countMID == 5) {
                if (midfragment!=null)
                    midfragment.maxSelectionMethod(true);
                ...
                if (midfragment!=null)
                    midfragment.maxSelectionMethod(false);
            }
            if (countFOR == 3) {
                if (forfragment!=null)
                    forfragment.maxSelectionMethod(true);
                ...
                if (forfragment!=null)
                    forfragment.maxSelectionMethod(false);
            }
        }
    }
