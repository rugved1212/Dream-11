package com.example.dream11.TeamsAndContest.CreateTeam.Kabaddi;
...
public class CreateKabaddiTeam extends AppCompatActivity implements DEFENDER.OnSelectedPlayerListener, ALL_ROUNDER.OnSelectedPlayerListener, RAIDER.OnSelectedPlayerListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_kabaddi_team);
        ...
        preview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                KabaddiBottomSheet kabaddiBottomSheet = new KabaddiBottomSheet(def, ar, raid, "", "", player_selected.getText().toString(), teamName(team1), teamName(team2));
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (selectedPlayers.size() >= 7) {
                    Intent intent = new Intent(CreateKabaddiTeam.this, Select_C_VC.class);
    ...
    public void onPlayersSelected(List<Player> selected) {
                ...
                while (iterator.hasNext()) {
                    ...
                    switch (currentFragmentTag) {
                        case "f0":
                            ...
                            break;
                        case "f1":
                            if (currentPlayer.getPlayer_position().equals("ALL-ROUNDER")) {
                                iterator.remove();
                                System.out.println("deleted" + currentPlayer);
                            }
                            ...
                            break;
                        case "f2":
                            if (currentPlayer.getPlayer_position().equals("RAIDER")) {
                                iterator.remove();
                                System.out.println("deleted" + currentPlayer);
                            }
        ...
        player_selected.setText(selectedPlayers.size() + "/7");
        if (selectedPlayers.size() >= 7) {
        ...
        double percent = selectedPlayers.size() * 14.2857143f;
        ...
        Log.w("countDEF", " "+countDEF);
        Log.w("countAR", " "+countAR);
        Log.w("countRAID", " "+countRAID);
        DEFENDER deffragment = (DEFENDER) getSupportFragmentManager().findFragmentByTag("f0");
        ALL_ROUNDER arfragment = (ALL_ROUNDER) getSupportFragmentManager().findFragmentByTag("f1");
        RAIDER raidfragment = (RAIDER) getSupportFragmentManager().findFragmentByTag("f2");
        ...
        if (selectedPlayers.size() == 7) {
            ...
            if (raidfragment!=null) {
                System.out.println("raidfound");
                raidfragment.maxSelectionMethod(true);
            }
        } else {
            if (countRAID == 3) {
                if (raidfragment!=null)
                ...
                if (raidfragment!=null)
                    raidfragment.maxSelectionMethod(false);
            }
            if (countDEF == 4) {
                if (deffragment!=null)
                    deffragment.maxSelectionMethod(true);
