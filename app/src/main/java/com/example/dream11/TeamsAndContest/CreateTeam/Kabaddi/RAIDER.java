 ...
 * Use the {@link RAIDER#newInstance} factory method to
 * create an instance of this fragment.
 */
public class RAIDER extends Fragment implements PlayerAdapt.OnItemClickListener {
    ...
    public static RAIDER newInstance(String param1, String param2) {
        RAIDER fragment = new RAIDER();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_r_a_i_d_e_r, container, false);
        ...
        reference.child("Team1").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    if (player.getPlayer_position().equals("RAIDER")) {
